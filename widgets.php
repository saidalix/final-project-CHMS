...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Ordering</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-10">
				<div class="panel panel-default">
					<div class="panel-heading">Ordering Form</div>
					<div class="panel-body">
						<form class="form-horizontal" action="connectsupl.php" method="POST">
							<fieldset>
								<!-- Name input-->
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="date_of_ordering" name="date_of_ordering" type="text" class="form-control">
									</div>
								</div>
...
$strquery="SELECT * from   ordering_supl";
...
$f=mysql_result($results,$i,"date_of_ordering");
$g=mysql_result($results,$i,"message");
...
<td><?php echo " <a href='edit_ordering.php?do=edit&id=" . $a . "'> edit </a> "; ?> | <?php echo " <a href='delete.php?id=" . $a . "'> delete </a> "; ?></td>

...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Chat Platform</h1>
			</div>
		</div><!--/.row-->
		<div class="row">
			<div class="col-lg-12">
...
{
$a=mysql_result($results,$i,"ChID");
$b=mysql_result($results,$i,"Emp_full_name");
$c=mysql_result($results,$i,"Eemail");
$d=mysql_result($results,$i,"message");
		...
		<div class="row">
			<div class="col-md-10">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="connectchat.php" method="POST">
							<fieldset>
								<!-- Name input-->
								<div class="form-group">
									<label class="col-md-3 control-label">Name</label>
									<div class="col-md-9">
									<input id="Emp_full_name" name="Emp_full_name" type="text" class="form-control">
									</div>
								</div>

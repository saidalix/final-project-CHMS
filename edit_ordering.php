      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
                <form id="form1" name="form1" method="get" action="update_ordering.php">
<label>

<table width="111%" border="0" align="center">
  <tr>
    <td width="22%"><strong>Supply Name:</strong></td>
  ...
  <tr>
    <td height="32"><strong>Date of Ordering  :</strong></td>
    <td><input name="date_of_ordering" type="text" id="date_of_ordering" value=" <?php echo $row["date_of_ordering"]; ?>" /></td>
    <td>&nbsp;</td>
